const CACHE="confin-5.3.4";
const ASSETS=["./","./index.html","./styles.css?v=5.3.4","./app.js?v=5.3.4","./manifest.webmanifest","./version.json","./icons/icon-192.png","./icons/icon-512.png","./icons/apple-touch-icon.png?v=5.3.4"];
