const CACHE="confin-5.2.3";
const ASSETS=["./","./index.html","./styles.css?v=5.2.3","./app.js?v=5.2.3","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png","./icons/apple-touch-icon.png?v=5.2.3"];
