const CACHE="confin-5.2.1";
const ASSETS=["./","./index.html","./styles.css?v=5.2.1","./app.js?v=5.2.1","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png","./icons/apple-touch-icon.png"];
