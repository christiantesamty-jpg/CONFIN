const CACHE="confin-5.3.0";
const ASSETS=["./","./index.html","./styles.css?v=5.3.0","./app.js?v=5.3.0","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png","./icons/apple-touch-icon.png?v=5.3.0"];
